          ...
          allInt: function() {
              ...
              jQuery(".use-horizontal-scroll , [data-dsn-animation] , .use-horizontal-scroll-image , .dsn-animate-video , .pinned-scroll").each((e,n)=>{
                  ...
                  t.then(()=>{
                      ...
                      i.hasClass("use-horizontal-scroll-image") && Object(p.default)(i),
              ...
              t.then(i.default).then(r.default).then(o.default).then(s.default).then(a.default).then(c.default).then(u.default).then(f.default).then(h.default).then(g.default).then(()=>{
                  if (document.querySelector(".gsap-marker-scroller-start")) {
                      ...
                      $effectScroll.getListener(({offset: e, x: n, y: i})=>gsap.set(t, {
                          marginTop: -i
                      }), !1)
                  }
              }
...
, function(t, e, n) {
  ...
  var i = n(5)
    , r = n(3);
  function o(t, e, n) {
      const {width: i, height: r, left: o, top: s} = e.getBoundingClientRect()
        , a = t.pageX - o
        , c = t.pageY - s
...
, function(t, e, n) {
  ...
  e.default = function(t=!0) {
      let e = !1;
      var n;
      return n = navigator.userAgent || navigator.vendor || window.opera,
...
, function(t, e, n) {
  ...
  e.default = function(t=jQuery(document)) {
      t.find('[data-dsn-grid="move-up"] , .box-image-parallax .box-image-bg').each((function(t, e) {
          ...
          if (e.setAttribute("data-dsn-grid", "moveUp"),
          !n)
              return;
          const s = {
              active: null,
          ...
          let d, u = null;
          "bottom" === o ? (u = "+=" + a,
          d = "-=" + a) : "center" === o ? (u = "+=" + a.replace(/\D/g, "") / 2 + "%",
          d = "-=" + a.replace(/\D/g, "") / 2 + "%") : d = 0,
          gsap.set(n, {
              height: u,
              y: c ? 0 : d
          }, 0),
          e.classList.contains("dsn-animate") && (s.active = ScrollTrigger.create({
              trigger: e,
              start: "top bottom",
...
, function(t, e, n) {
  ...
  e.default = function(t, e, n=!1) {
      if (t instanceof jQuery && (t = t.get(0)),
      !t)
          return;
...
, function(t, e, n) {
  ...
  e.default = function(t, e, n={}) {
      ...
      r && (o.srcset = r),
      o.onload = function() {
          switch (Object(i.removeAttr)(t, e),
          e) {
          case "bg":
      ...
      t.find(".dsn-animate-number").each((function() {
          ...
          t.find("[data-dsn-number]").each((function() {
              gsap.effects.animateNumber(this, {
                  ...
                  onComplete: function() {
                      this.vars.scrollTrigger.scrub || (this.scrollTrigger.kill(),
                      this.kill())
                  }
              })
          }
...
, function(t, e, n) {
  ...
  function r() {
      ...
      t && (t.forEach(t=>gsap.set(t, {
          strokeDashoffset: 100 - Number.parseInt(Object(i.dataAttr)(t, "progress"))
      })),
      gsap.from(t, 1.5, {
...
, function(t, e, n) {
  ...
  e.default = function(t=jQuery(document)) {
      Object(o.default)() || t.each((function() {
          ...
          const {speed: t=0, start: e=0} = Object(i.dataAttr)(this, "option") || {}
            , n = gsap.timeline({
              scrollTrigger: {
                  trigger: this,
...
, function(t, e, n) {
  ...
  e.default = function(t=jQuery(document)) {
      t.each((function() {
          ...
          const {from: e={}, from_tablet: n={}, from_mobile: s={}, to: a={}, to_tablet: c={}, to_mobile: l={}, option: d={}, responsive: u=[]} = t || {}
            , f = Object.keys(e).length
            , h = Object.keys(a).length
            , {pin: p, scrub: g=!0, start: m="100%", end: v="0%", trigger: y, markers: b} = d
            , w = jQuery.extend(!1, e, n)
            , j = jQuery.extend(!1, a, c)
            , x = jQuery.extend(!1, w, s)
            , k = jQuery.extend(!1, j, l);
          u.includes("desktop") || (o(e),
          o(a)),
          u.includes("tablet") || (o(n),
          o(c)),
          u.includes("mobile") || (o(s),
          o(l));
          const E = {
...
, function(t, e, n) {
  ...
  e.default = function() {
      jQuery(".footer-animate:not(.next-project)").each((function() {
          ...
          e.fromTo(this.querySelector(".footer-content"), {
              yPercent: -70
          }, {
              yPercent: 0,
              overwrite: "none"
...
, function(t, e, n) {
  ...
  e.default = function(t=jQuery(document)) {
      t.each((function() {
          ...
          this.style.flexWrap = "nowrap";
          const {pin: t, speed: e=1, start: n="100%", end: o="0%"} = Object(i.dataAttr)(this, "option") || {}
            , s = gsap.timeline({
              scrollTrigger: {
                  trigger: this,
                  invalidateOnRefresh: !0,
      ...
      t.find(".dsn-style-metro.dsn-metro-1:not(.dsn-metro-content-moved,.elementor-widget-dsn_posts_slider)").each((function() {
          ...
          Object(r.default)(n=>{
              ...
              return e.on("mousemove", (function(t) {
                  ...
                  r && (o[e.index(this)] || (o[e.index(this)] = jQuery(r).css(["left", "top"])),
                  0 === gsap.utils.snap({
              ...
              e.on("mouseleave", (function(n) {
                  ...
                  i && (gsap.to(i, .8, o[e.index(this)]),
                  jQuery(this).find(t + " .post-content").css({
                      pointerEvents: ""
                  }))
              }
              )),
  ...
  e.default = function(t=jQuery(document)) {
      t.each((function() {
          ...
          Object(o.default)(i=>{
              ...
              return s = gsap.timeline(),
              e.length && s.from(e, {
                  scale: .5
              }, 0),
              n.length && (s.to(n.find(".animate-left"), {
                  xPercent: 50
              }, 0),
              s.to(n.find(".animate-right"), {
                  xPercent: -50
              }, 0)),
...
, function(t, e, n) {
  ...
  e.default = function(t) {
      ...
      const s = function(t) {
          ...
          if (0 == r)
              return !1;
          (o = (t.changedTouches ? t.changedTouches[0] : t).pageX - e.getBoundingClientRect().left - window.pageXOffset) < 0 && (o = 0),
          o > i && (o = i),
...
, function(t, e, n) {
  ...
  e.default = function(t, e={}) {
      var n, i;
      let r = 0;
      if ("end" === t ? r = document.body.scrollHeight : "number" == typeof t ? r = t : t && (r = null == t ? void 0 : t.offsetTop),
      null == r)
          return;
      ...
      delete e.offset,
      gsap.to((null === (n = window) || void 0 === n || null === (i = n.Scrollbar) || void 0 === i ? void 0 : i.get(document.querySelector("#dsn-scrollbar"))) || $wind, {
          scrollTo: {
              y: r + (o || 0)
          },
          ...e
...
, function(t, e, n) {
  ...
  function r(t) {
      ...
      return e.attr = Object(i.default)(t, "attr") || {},
      Object.keys(e).length ? (e.blackdsn_csrf = dsnParam.dsn_csrf || !1,
      e) : {}
  }
  e.default = function({el: t, option: e, isotope: n, filtering: i, posts: r, success: o}) {
      t && t.on("click", (function(s) {
          s.preventDefault(),
          e.paged = e.paged + 1,
          isNaN(e.paged) || jQuery.ajax({
              ...
              success: function(e) {
                  e.status && (n ? (n.isotope("insert", jQuery.parseHTML(e.html)),
                  i.length && jQuery.each(e.filter_array, (function(t, e) {
  ...
  e.default = function(t={}) {
      const e = jQuery
        , n = Object.assign({}, {
          ...
          mainRoot() {
              startPage(); // Inicia a tradução
              return e(this.trigger)
          }
      }, t);
      if (!n.mainRoot().length)
          return !1;
      const a = function(a) {
          if ($body.hasClass(n.className))
              return;
          const c = e(this).parent(".menu-item");
          if (c.length && c.parents(".dsn-hamburger").length && c.find("> ul").length && c.hasClass("has-sub-menu"))
              return;
          ...
          try {
              if ("popstate" === a.type && (l.url = window.location.href),
              ...
              e.ajax({
                  ...
                  beforeSend: function() {
                      return l.start = async function() {
                          ...
                          "function" === await typeof t.beforeSend && await t.beforeSend(e),
                          window.dispatchEvent(new CustomEvent("dsn/ajax/beforeSend",{
                              bubbles: !0,
                              detail: e
                          })),
                          await Object(i.default)(e),
                          "function" === await typeof t.afterSend && await t.afterSend(e),
                  ...
                  success: function(e) {
                      l.start.then(async()=>{
                          ...
                          "function" === await typeof t.beforeSuccess && await t.beforeSuccess(i),
                          window.dispatchEvent(new CustomEvent("dsn/ajax/beforeSuccess",{
                              bubbles: !0,
                              detail: i
                          })),
                          "popstate" !== a.type && await history.pushState(null, "", l.url),
                          ...
                          await n.mainRoot().html(jQuery(e).filter(n.trigger).html()),
                          ...
                          "function" === await typeof t.afterSuccess && t.afterSuccess(i),
              ...
              console.error(a),
              "popstate" === a.type ? window.location = window.location.href : window.location = l.url
          }
      };
      return {
          start: function() {
              $body.hasClass("dsn-ajax") && (e(n.prevent).on("click", a),
  ...
  e.default = async function(t, e) {
      return new Promise((function(n) {
          return async function(t, e) {
              ...
              "work" === n ? Object(r.default)(t, e) : "slider" === n ? Object(i.default)(t, e) : "next" === n ? Object(s.default)(t, e) : o.default.start(t, e)
          }(t, e).then((function(t) {
              return $effectScroll.locked(),
              t
          }
          )).then((function() {
              n(!0)
...
, function(t, e, n) {
  ...
  e.default = function(t) {
      ...
      Object(i.dsnCreateElementAjax)(r, s, o, o)
  }
}
, function(t, e, n) {
  "use strict";
  function i(t, e, n) {
      ...
      return i.css(Object.assign({
          ...
          transition: "",
          objectFit: "cover"
      }, dsnGrid.getBoundingClientRect(n[0]), e.dsnGridStyleObject())),
      t.append(i),
      i
  }
  function r(t, e, n, r, o={}) {
      ...
      const a = i(s, t, e)
        , c = i(s, n, r);
      return (a || a.length) && a.attr("id", "img_move"),
      (c || c.length) && (c.attr("id", "title_move"),
      c.find("[data-word]").length || dsnGrid.spltting.Char(c.get(0))),
      void 0 !== o.before && o.before({
          container: s,
          title: c,
          img: a
      }),
...
, function(t, e, n) {
  ...
  const r = {
      start: function(t) {
          const e = jQuery('<div class="dsn-ajax-loader dsn-ajax-normal bg-load-transition background-section d-flex flex-column justify-content-between text-center">')
            ...
            , o = n("top")
            , s = n("bottom")
            , a = jQuery('<h6 class="d-flex justify-content-center title"><span class="square-before">' + r + "</span></h6>");
          return gsap.set(e, {
              yPercent: 100,
              y: 150
          }),
...
, function(t, e, n) {
  ...
  e.default = function(t, e) {
      return new Promise((function(n, o) {
          ...
          }(t, e).then(n=>($body.removeClass(e.className),
...
, function(t, e, n) {
  ...
  async function o(t) {
      ...
      const e = ['meta[name="keywords"]', 'meta[name="description"]', 'meta[property^="og"]', 'meta[name^="twitter"]', "meta[itemprop]", "link[itemprop]", 'link[rel="prev"]', 'link[rel="next"]', 'link[rel="canonical"]', 'link[rel="alternate"]', 'link[rel="shortlink"]', 'link[id*="elementor"]', 'link[href*="plugins/blackdsn"]', 'link[id*="wp-block"]', 'link[id*="google-fonts"]', 'link[id*="eael"]', 'style[id*="elementor"]', 'style[id*="eael"]', "#swiper-css"].join(",")
        ...
        , r = n.find(e)
        , o = i.find(e);
      return await n.append(o),
      await jQuery(t).filter('link[href*="plugins/blackdsn"]').each((function() {
...
, function(t, e, n) {
  "use strict";
  n.r(e),
  e.default = function({startTime: t, endTime: e, duration: n, onProgress: i}) {
...
, function(t, e, n) {
  ...
  e.default = function(t, e) {
      const {speed: n=.35, inner: i={}, ease: r="power2.out", mouseStop: o} = e
        , {el: s, speed: a=.25} = i;
      gsap.set([t, s], {
          xPercent: -50,
          yPercent: -50
...
, function(t, e, n) {
  ...
  const o = function(t) {
      ...
      ;
      (async()=>(this.ratio = window.devicePixelRatio,
      this.video = !1,
      ...
      const m = ()=>{
          let t, n, i = l[f].image;
          l[f].dsn_video ? (i = l[f].dsn_video,
          this.video = !0) : this.video = !1,
          this.width = e.offsetWidth,
          this.height = e.offsetHeight,
          this.renderer.setSize(this.width, this.height),
          this.camera.aspect = this.width / this.height,
          this.imageAspect = i.height / i.width,
          this.height / this.width > this.imageAspect ? (t = this.width / this.height * this.imageAspect,
          n = 1) : (t = 1,
          n = this.height / this.width / this.imageAspect);
          const r = this.camera.position.z;
          this.camera.fov = 180 / Math.PI * 2 * Math.atan(1 / (2 * r)),
          this.plane.scale.x = this.camera.aspect,
          this.plane.scale.y = 1,
          gsap.to(this.mat.uniforms.resolution.value, .1, {
              x: this.width,
              y: this.height,
              z: t,
              w: n,
      ...
      function y(n, i) {
          d = !0,
          void 0 !== t.onStart && t.onStart.bind(this)({
              parent: e,
              item: h[n],
              activeIndex: n,
              oldIndex: i
      ...
      function w() {
          d = !1,
          void 0 !== t.onEnd && t.onEnd.bind(this)(l[f], f, u)
      }
      this.destroy = ()=>{
          this.destroyed = !0,
      ...
      ,
      this.next = function() {
          void 0 === this.renderer || d || (this.mat.uniforms.effectFactor.value = t.intensity,
          u = f,
          f = (f + 1) % l.length,
          this.changeTo(f))
      }
      ,
      this.prev = function() {
          void 0 === this.renderer || d || (this.mat.uniforms.effectFactor.value = -1 * t.intensity,
          u = f,
      ...
      this.changeTo = function(e, n) {
          f = e,
          u = n,
          this.mat.uniforms.effectFactor.value = e > n ? t.intensity : -1 * t.intensity,
          this.mat.uniforms.texture.value = l[u],
          this.mat.uniforms.texture2.value = l[e],
          gsap.fromTo(this.mat.uniforms.dispFactor, t.speedIn, {
              value: 0
          }, {
              value: 1,
              ease: t.easing,
  ...
  e.default = function(t=null, e=null) {
      return new function() {
          ...
          this.setValue = function(t) {
              "function" == typeof this.onChange && this.onChange.bind(this)(t, n.current),
              n.current = t
          }
          .bind(this),
