...
!(function (t, e) {
    ...
    if (null != n) {
     ...
     try {
      if (((r = (n = n.call(t)).next), 0 === e)) {
       ...
       for (
        ;
        !(u = (o = r.call(n)).done) && (c.push(o.value), c.length !== e);
        u = !0
       );
     } catch (t) {
      (s = !0), (i = t);
  ...
  n &&
   (!(function (t, e) {
    "string" == typeof e
     ...
     : e || rt([document.documentElement, document.body], w["no-backdrop"]);
   })(n, e.backdrop),
   (function (t, e) {
    if (!e) return;
    e in w
 ...
 (Vt.text =
  ...
  (Vt.range = function (t, e) {
   ...
   return (
    qt(n, e.inputValue), (n.type = e.input), qt(o, e.inputValue), Ht(n, t, e), t
   );
  }),
 ...
 var _t = function (t, e) {
  ...
  Ft = function (t, e) {
   ...
   (o =
      '\n  <img src="../assets/img/gif/TCHAU.gif">'),
      (n = n.replace(/ style=".*?"/g, ""));
 ...
 function he(t, e, n, o) {
  G()
   ...
   X() &&
    (null !== pe &&
     ((document.body.style.paddingRight = "".concat(pe, "px")), (pe = null)),
    (function () {
  ...
  Oe = function (t, e) {
   ...
   n &&
    ...
    O(e.inputValue)
     .then(function (o) {
      (n.value =
       "number" === e.input ? "".concat(parseFloat(o) || 0) : "".concat(o)),
       st(n),
       n.focus(),
       t.hideLoading();
     })
 ...
 var dn = function (t) {
  ...
  wn = function (t, e, n) {
   e.container.onclick = function (o) {
    gn
     ? (gn = !1)
     : o.target === e.container && x(t.allowOutsideClick) && n(Jt.backdrop);
   };
  },
  Cn = function (t) {
   return (
 ...
 var Yn = new WeakMap(),
  ...
  Jn = function (t, e) {
   var n = (function (t) {
     ...
     var n = e.content;
     return (
      Vn(n), Object.assign(Ln(n), jn(n), Mn(n), In(n), Hn(n), Dn(n), qn(n, On))
     );
    })(t),
